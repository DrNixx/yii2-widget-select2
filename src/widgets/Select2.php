...
use onix\assets\AssetBundle;
use onix\assets\Select2Asset;
use Yii;
...
class Select2 extends InputWidget
{
    ...
    /**
     * Select2 Bootstrap theme (default)
     */
     ...
     *   `<i class="fa fa-check-square-o"></i> Unselect all`.
    ...
    protected function renderToggleAll()
    {
        ...
        $settings = array_replace_recursive([
            'selectLabel' => '<i class="fa fa-square-o"></i>' . Yii::t('onix-select', 'Select all'),
            'unselectLabel' => '<i class="fa fa-check-square-o"></i>' . Yii::t('onix-select', 'Unselect all'),
            'selectOptions' => [],
            'unselectOptions' => [],
